...
modified_numbers = [num * 2 if num % 2 == 0 else 0 for num in numbers]
...
number_letter_pairs = [(num, let) for num in small_numbers for let in letters]
...
filtered_pairs = [(num, vow) for num in more_numbers for vow in vowels if num % 2 == 0 and vow in ["a", "e"]]